...
export default function GameLayout() {
  ...
  useEffect(() => {
    if (walletType === 'demo' && connected) {
      updateDemoWalletBalance(usdtBalance.toString())
    }
  }, [usdtBalance, walletType, connected])
                ...
                {sasBalance > 0 && (
                  <>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-purple-400 text-sm">{formatBalance(sasBalance)}</span>
                    </div>
                  </>
                )}
                ...
                {hasShieldProtection() && (
                  <>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-bold text-blue-400 text-sm">{inventory.shields}</span>
                    </div>
                  </>
                )}
