      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-slate-800/80 rounded-xl p-3 border border-slate-600">
            <div className="text-xs text-white text-outline-dark mb-1">Balance</div>
            <div className="text-lg font-bold text-white text-outline-gold truncate">{formatBalance(balance)}</div>
          </div>
          <div className="bg-slate-800/80 rounded-xl p-3 border border-slate-600">
        ...
        {phase === 'result' && raidResult && (
          ...
          >
            ...
            <h2 className={`text-3xl font-bold mb-2 text-white ${
              raidResult.success ? 'text-outline-green' : 'text-outline-dark'
            }`}>
