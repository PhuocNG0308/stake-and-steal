        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-6xl mb-12">
          {[
            ...
            <motion.div
              ...
              className="card-panel text-center bg-white/90 backdrop-blur-sm border-4 border-royal-blue-dark"
            >
              <div className="text-6xl mb-4 drop-shadow-md">{item.emoji}</div>
              <h3 className="font-black text-2xl mb-2 text-royal-blue-dark text-stroke-sm shadow-white">{item.title}</h3>
              <p className="text-royal-blue-900 font-bold">{item.desc}</p>
            </motion.div>
          ))}
        </div>
