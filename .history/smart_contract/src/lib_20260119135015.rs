...
pub enum Message {
    ...
    TargetList { requester: ChainId, targets: Vec<TargetInfo>, request_id: u64 },
    StealAttempt { attacker_chain: ChainId, target_page: u8, target_plot: u8, attack_seed: [u8; 32] },
    StealOutcome { success: bool, amount_stolen: u128 },
...
impl Page {
    pub fn new(id: u8, current_block: u64) -> Self {
        let plots = (0..MAX_PLOTS_PER_PAGE)
            ...
            .collect();
        Self { id, is_unlocked: true, plots, created_at: current_block }
    }
