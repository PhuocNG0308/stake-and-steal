...
use linera_sdk::base::{AccountOwner, ApplicationId, ChainId, Owner, Timestamp};
...
impl linera_sdk::base::ContractAbi for StealAndYieldAbi {
...
impl linera_sdk::base::ServiceAbi for StealAndYieldAbi {
    type Parameters = ApplicationParameters;
