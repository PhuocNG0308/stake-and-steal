    ...
    (set, get) => ({
      ...
      tickYield: (settings) => {
        ...
        set({
          playerFarm: {
            ...playerFarm,
            pendingYield: playerFarm.pendingYield + newYield,
          },
          lastTickTime: Date.now(),
        })
      },
